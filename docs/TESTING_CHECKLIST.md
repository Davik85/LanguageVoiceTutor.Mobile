...
- Verified signing result: exactly `app/build/app/outputs/bundle/release/app-release.aab`, 191983753 bytes, AAB SHA-256 `8C633D4689066BF0BE17B7B7AA266B4049750965092D5642C589DF5F6865A7ED`, embedded upload SHA-1 `60:A8:13:5D:A6:B1:72:00:F2:6A:80:D2:F9:91:A9:01:CC:EB:F8:9B`, and embedded upload SHA-256 matching the expected value above.
- Core Internal smoke testing passed on three physical Android devices, including Android 13 and Android 16: login, account settings, History, Progress, lesson start, microphone permission, speech recognition, notifications, notification disable behavior, and initial system-language detection for application and native language worked as expected. No obvious critical application errors were found. Extended exploratory testing remains ongoing; this is not complete physical QA or public-release readiness.
- The upload-key reset remains processing. Do not upload the current AAB or create a new AAB until processing is complete and `versionCode` has been increased.
