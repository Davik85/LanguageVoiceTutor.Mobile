...
- Keep pending: automatic tutor playback, GIF avatar state binding, realtime/continuous voice conversation, broader physical-device voice repetition across several lessons and repeated first-attempt voice selections, history/progress screen, mobile billing, analytics, crash reporting, and store release work. Missing Lesson Chat avatar assets remain a separate issue.
...
- Keep automatic tutor playback, GIF avatar state integration, broader physical-device voice repetition, and realtime/continuous voice conversation as future isolated work.
